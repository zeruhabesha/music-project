...
import axios from "axios"; // Use axios directly for more control
...
function CrudAdd(props) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (error.response) {
        ...
        const parsedErrorMessage = error.response.data?.message || error.response.statusText;
        setErrorMessage(parsedErrorMessage);
      } else {
  ...
  {/* File inputs for songFile and imageFile */}
       <div className="form-group">
